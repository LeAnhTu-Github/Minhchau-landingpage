...
export default function ProjectDetail() {
  ...
  const project = projectData[slug || ""] || projectData["vr-360"];
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid lg:grid-cols-12 gap-16">
            <div className="lg:col-span-8 flex flex-col gap-16">
              <div className="rounded-[40px] overflow-hidden border border-slate-800 shadow-2xl">
                <ImageWithFallback src={project.img} alt={project.title} className="w-full h-auto" />
              </div>
            ...
            <div className="lg:col-span-4">
              <div className="sticky top-24 p-8 bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 rounded-[40px] shadow-2xl flex flex-col gap-8">
                ...
                <Link to="/contact" className="w-full px-8 py-4 bg-cyan-600 hover:bg-cyan-500 text-white font-bold rounded-xl shadow-xl shadow-cyan-900/30 transition-all flex items-center justify-center gap-2">
