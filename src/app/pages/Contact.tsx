...
import { Mail, Phone, MapPin, Send, MessageSquare, CheckCircle2, Clock, ShieldCheck, FileCheck } from "lucide-react";
...
export default function Contact() {
  ...
  const onSubmit = async (data: ContactFormData) => {
    ...
    toast.success("Yêu cầu đã được gửi! Minh Châu sẽ liên hệ lại với bạn sớm nhất.");
    reset();
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 text-center flex flex-col items-center gap-8">
          ...
          >
            <h1 className="text-4xl md:text-7xl font-extrabold text-white tracking-tight leading-tight">
              Liên hệ <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">Minh Châu</span>
            </h1>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-5 flex flex-col gap-12">
              ...
              <div className="flex flex-col gap-6 p-10 bg-gradient-to-br from-cyan-600 to-blue-700 rounded-[40px] text-white shadow-2xl">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex flex-col gap-2">
                    ...
                    <input
                      ...
                      type="text"
                      className={`px-5 py-4 bg-slate-950 border ${errors.fullName ? 'border-red-500' : 'border-slate-800'} rounded-2xl text-white focus:outline-none focus:border-cyan-500 transition-all`}
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <input
                      ...
                      type="tel"
                      className={`px-5 py-4 bg-slate-950 border ${errors.phone ? 'border-red-500' : 'border-slate-800'} rounded-2xl text-white focus:outline-none focus:border-cyan-500 transition-all`}
                  ...
                  <div className="flex flex-col gap-2 md:col-span-2">
                    ...
                    <select
                      ...
                      className={`px-5 py-4 bg-slate-950 border ${errors.service ? 'border-red-500' : 'border-slate-800'} rounded-2xl text-white focus:outline-none focus:border-cyan-500 transition-all appearance-none`}
                    >
