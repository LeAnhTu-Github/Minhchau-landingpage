...
export default function Home() {
  return (
    <div className="flex flex-col">
      ...
      <section className="py-24 relative">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, i) => (
              ...
              >
                ...
                <Link to="/services" className="text-xs font-bold text-cyan-500 flex items-center gap-1 group/link">
          ...
          <div className="mt-16 flex justify-center">
            <Link to="/services" className="px-8 py-3 bg-slate-800 hover:bg-slate-700 text-white font-bold rounded-xl transition-all">
              Xem tất cả dịch vụ
            </Link>
          </div>
        </div>
            ...
            <div className="relative">
              <div className="grid grid-cols-2 gap-4">
                <div className="aspect-square rounded-3xl overflow-hidden shadow-2xl">
                  <ImageWithFallback src="https://images.unsplash.com/photo-1581092918056-0c4c3acd3789" alt="Tech" className="w-full h-full object-cover" />
                </div>
                <div className="aspect-square rounded-3xl overflow-hidden shadow-2xl mt-8">
                  <ImageWithFallback src="https://images.unsplash.com/photo-1522071820081-009f0129c71c" alt="Team" className="w-full h-full object-cover" />
                </div>
              </div>
      ...
      <section className="py-24">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            ...
            <Link to="/projects" className="px-6 py-3 border border-slate-800 hover:bg-slate-900 text-white font-bold rounded-xl flex items-center gap-2 shrink-0 transition-all">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {projects.map((project, i) => (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: i * 0.1 }}
                viewport={{ once: true }}
                className="group relative rounded-3xl overflow-hidden border border-slate-800 bg-slate-900/50"
              >
      ...
      <section className="py-24 bg-slate-950">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="mt-16 flex flex-col items-center gap-6">
            <Link to="/contact" className="px-10 py-5 bg-gradient-to-r from-cyan-600 to-blue-700 hover:from-cyan-500 hover:to-blue-600 text-white font-bold rounded-2xl shadow-2xl shadow-blue-900/40 text-lg transition-all hover:scale-105">
      ...
      <section className="py-24">
        <div className="container mx-auto px-4 md:px-6">
          <div className="bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 rounded-[40px] p-12 md:p-24 relative overflow-hidden text-center flex flex-col items-center gap-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/contact" className="px-10 py-5 bg-cyan-600 hover:bg-cyan-500 text-white font-bold rounded-xl shadow-xl shadow-cyan-900/30 transition-all hover:scale-105">
                Gửi yêu cầu tư vấn
              </Link>
              <Link to="/about" className="px-10 py-5 bg-transparent border border-slate-700 hover:bg-slate-800 text-white font-bold rounded-xl transition-all">
