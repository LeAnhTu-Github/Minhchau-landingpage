        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="flex flex-col gap-6">
            <Link to="/" className="flex items-center gap-2 group">
              <div className="w-10 h-10 bg-gradient-to-br from-cyan-500/20 to-blue-600/20 border border-cyan-500/30 rounded-lg flex items-center justify-center">
          ...
          <div className="flex flex-col gap-6">
            ...
            <ul className="flex flex-col gap-3 text-sm">
              ...
              <li><Link to="/services" className="hover:text-cyan-400 transition-colors">Dịch vụ</Link></li>
              <li><Link to="/projects" className="hover:text-cyan-400 transition-colors">Dự án tiêu biểu</Link></li>
              <li><Link to="/contact" className="hover:text-cyan-400 transition-colors">Liên hệ báo giá</Link></li>
            </ul>
          </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <ul className="flex flex-col gap-3 text-sm">
              <li><Link to="/services" className="hover:text-cyan-400 transition-colors">Phát triển phần mềm</Link></li>
              <li><Link to="/services" className="hover:text-cyan-400 transition-colors">Tích hợp viễn thông</Link></li>
              <li><Link to="/services" className="hover:text-cyan-400 transition-colors">Vận hành & Bảo trì SLA</Link></li>
              <li><Link to="/services" className="hover:text-cyan-400 transition-colors">Kiểm thử QA</Link></li>
            </ul>
          </div>
